<template>
    <div class="h-screen flex flex-col justify-center items-center">
        ...
        <div class="mt-28 h-[80vh] flex items-center max-w-screen-lg overflow-auto">
        ...
        <div class="h-[20vh] flex md:flex-row flex-col items-center justify-center"> 
            <p class="text-xs flex flex-row items-center text-center transition ease-in-out text-slate-400 hover:text-slate-900">
                Created with 
            ...
            <p class="text-xs flex flex-row items-center text-center transition ease-in-out text-slate-400 hover:text-slate-900">
                ...
                <b class="ml-1"><a href="https://shuashuaa.netlify.app">Jovi Joshua Tania</a> </b>
            </p>
        </div>
...
import { reactive } from 'vue'
    ...
    const lists = reactive([
        { name:'001 - Ref & Reactive', image: '', to: '/filter'},
        { name:'002 - Filter & Computed', image: '', to: '/filter'},
        { name:'003 - asd', image: '', to: '/computed'},
        { name:'004 - Watch & Search', image: '', to: '/filter'},
        { name:'005 - Sort', image: '', to: '/filter'},
        { name:'006 - Transition', image: '', to: '/filter'},
        { name:'007 - FlexBox', image: '', to: '/filter'},
        { name:'008 - Grid', image: '', to: '/filter'},
        { name:'009 - Odd & Even', image: '', to: '/filter'}, //even:bg-red-100 odd:bg-blue-100
        { name:'010 - ', image: '', to: '/'},
        { name:'011 - ', image: '', to: '/'},
        { name:'012 - ', image: '', to: '/'},
        { name:'013 - ', image: '', to: '/'},
        ...
        { name:'022 - ', image: '', to: '/'},
        { name:'023 - ', image: '', to: '/'},
        { name:'024 - Print This', image: '', to: '/filter'}, //Hi! I'm Josh, I wanna say you're awesome! keep going 'kay?, hai hai!
        { name:'025 - Dark Mode', image: '', to: '/filter'},
    ])
</script>
